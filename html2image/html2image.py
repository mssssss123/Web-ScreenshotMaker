...
sys.path.append('/Users/meisen/Desktop/Web-ScreenshotMaker/html2image')
import io
import time
import JSInjection
...
class Html2Image:
    def __init__(self, url, jscode=None):
        self.browser = webdriver.PhantomJS(executable_path='/Users/meisen/Desktop/Web-ScreenshotMaker/phantomjs-2.1.1-macosx/bin/phantomjs')
...
if __name__ == '__main__':
    h2i = Html2Image("https://orainternals.wordpress.com/2012/02/13/temporary-tablespaces-in-rac/", JSInjection.Scroll2Bottom())
    h2i.save_image()
